...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        ...
        <div class="bg-gray-800 shadow-2xl rounded-lg overflow-hidden">
            ...
            <div class="px-8 py-6">
                @if(session('success'))
                    <div class="mb-4 bg-green-900 border border-green-700 text-green-200 px-4 py-3 rounded" role="alert">
                ...
                <form method="POST" action="{{ route('management.login.submit') }}" class="space-y-6">
                    @csrf
        ...
        <div class="text-center mt-6">
            <a href="{{ url('/') }}" class="text-gray-400 hover:text-gray-300 text-sm flex items-center justify-center space-x-1">
