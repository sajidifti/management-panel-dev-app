...
class ManagementSessionHandler
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $lifetime = config('management.session.lifetime');
        ...
        $request->attributes->set('management_session_id', $sessionId);

        $response = $next($request);

        // Save session data back to file
        $updatedSessionData = $request->attributes->get('management_session', []);
    ...
    {
        $sessionDir = config('management.session.path');
